...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train LoRA adapter with TRL SFTTrainer.")
    parser.add_argument("--model", default="Qwen/Qwen2.5-7B-Instruct")
    parser.add_argument("--train-file", required=True)
    parser.add_argument("--valid-file", default="")
    parser.add_argument("--output-dir", default="ai-stack/training/output/lora-xiaoan")
